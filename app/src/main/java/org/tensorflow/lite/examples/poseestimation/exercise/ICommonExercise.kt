...
abstract class ICommonExercise (
    context: Context,
    val id: Int,
    ...
    abstract fun rightExerciseCount(person: Person, canvasHeight: Int,canvasWidth: Int, phases: List<Phase>)
    abstract fun wrongExerciseCount(person: Person, canvasHeight: Int, canvasWidth: Int, phases: List<Phase>)
